    ...
    if (bAlreadyAccepted == false) {
      ...
      new Dialog.OnClickListener() {
        ...
        DialogInterface dialogInterface, int i) {
          ...
          // Set onboarding alert message for managing convos
          String ckBoxName = "cbMsgStream";
          String title = "Welcome to Meme Chat";
          CharSequence msg = Html.fromHtml("Thanks for trying this app out! " +
          "You can check out your existing conversations if you have any" +
          " or use the plus button at the top to start a new conversation.");
